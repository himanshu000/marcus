...
- Navigate to `marcus` folder
- Select `marcus.bot` file
...
msbot clone services --name "marcus" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
